...
guest = User.create!([
  {username: "guest", password: "password", name: "Awesome Guest", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  ...
  {username: "d_tanner", password: "password", name: "Danny Tanner", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "g_newsom", password: "password", name: "Gavin Newsom", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "oprah", password: "password", name: "Oprah Winfrey", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "terminator", password: "password", name: "Arnold Schwarzenegger", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "dannyglover", password: "password", name: "Danny Glover", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "tom_hanks", password: "password", name: "Tom Hanks", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "jgarcia", password: "password", name: "Jerry Garcia", profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "CSantana", password: "password", name: "Carlos Santana",  profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "Twain", password: "password", name: "Mark Twain",  profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"},
  {username: "lucas_george", password: "password", name: "George Lucas",  profile_picture_url: "https://s-media-cache-ak0.pinimg.com/564x/4d/3d/2b/4d3d2ba3ecc8592f8e64a54d25ca9dc7.jpg"}
])
...
comments = Comment.create!([
  {user_id: rand_id, picture_id: 44, body: "what a cool thing"},
  {user_id: 1, picture_id: 44, body: "lorem ipsum"},
  {user_id: 1, picture_id: 43, body: "woahhh very cool"},
  {user_id: rand_id, picture_id: 43, body: "I've been there before"},
  {user_id: rand_id, picture_id: 43, body: "Why wasn't I invited?"},
  {user_id: rand_id, picture_id: 42, body: "hello world"},
  {user_id: rand_id, picture_id: 42, body: "hey there"},
  {user_id: rand_id, picture_id: 41, body: "beautiful"},
  {user_id: rand_id, picture_id: 41, body: "lorem ipsum"},
  {user_id: rand_id, picture_id: 41, body: "great picture"},
  {user_id: rand_id, picture_id: 40, body: "Did you take that on a nikon?"},
  {user_id: rand_id, picture_id: 40, body: "ok ok pretty cool pretty cool"},
  {user_id: rand_id, picture_id: 40, body: "wooooot"},
  {user_id: rand_id, picture_id: 39, body: "lorem ipsum"},
  {user_id: rand_id, picture_id: 37, body: "lorem ipsum"},
  {user_id: rand_id, picture_id: 36, body: "lorem ipsum"},
  ...
  {user_id: 8, picture_id: 36, body: "Mo's app is fun :)"},
  {user_id: 6, picture_id: 34, body: "I'll be back"},
  {user_id: 7, picture_id: 34, body: "smh..."},
  {user_id: 3, picture_id: 33, body: "Very clean!"},
  {user_id: rand_id, picture_id: 33, body: "woaahhhhh"},
  {user_id: rand_id, picture_id: 1, body: "woaahhhhh"},
  {user_id: rand_id, picture_id: 1, body: "Great pic!"},
  {user_id: rand_id, picture_id: 1, body: "Where was that?"},
  {user_id: rand_id, picture_id: 10, body: "LOL"},
  {user_id: rand_id, picture_id: 10, body: "What's so funny?"},
  {user_id: rand_id, picture_id: 10, body: "great seed data"},
  {user_id: rand_id, picture_id: 20, body: "Ahhh so nice"},
  {user_id: rand_id, picture_id: 20, body: "Yes it is"},
  {user_id: rand_id, picture_id: 20, body: "Sono venuto qui"},
  {user_id: rand_id, picture_id: 23, body: "Hello Hello"},
  {user_id: rand_id, picture_id: 23, body: "I don't know why you say.."},
  {user_id: rand_id, picture_id: 23, body: "goodbye, I say hello"},
  {user_id: rand_id, picture_id: 11, body: "Hmmm I don't know about that"},
  {user_id: rand_id, picture_id: 11, body: "LOL OMG"},
  {user_id: rand_id, picture_id: 20, body: "You may say I'm a dreamer.."},
  {user_id: rand_id, picture_id: 20, body: "but I'm not the only one.."},
  {user_id: 8, picture_id: 24, body: "Bernie 2016"},
  {user_id: 6, picture_id: 24, body: "Really!?!?"},
  {user_id: rand_id, picture_id: 45, body: "Dude, that is NYC"},
  {user_id: rand_id, picture_id: 45, body: "Not cool!"},
  {user_id: rand_id, picture_id: 45, body: "What's wrong with NY??"},
  {user_id: 1, picture_id: 47, body: "Hey, that's pretty nice"},
  {user_id: 1, picture_id: 47, body: "Actually, very nice"},
  {user_id: rand_id, picture_id: 47, body: "I agree"},
  {user_id: 1, picture_id: 46, body: "Hello World"},
  {user_id: 1, picture_id: 45, body: "Yay, another comment"},
  ])
